...
export default function Reports() {
  ...
  const handleExportPDF = () => {
    ...
    toast({ title: "Export Complete", description: "HACCP Report downloaded." });
  };
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <p className="text-sm text-muted-foreground">Download current menu allergen overview.</p>
             <div className="flex gap-2">
              <Button variant="secondary" className="flex-1" onClick={() => toast({ title: "Coming Soon", description: "This report is not yet implemented in mock." })}>
